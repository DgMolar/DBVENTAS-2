                        ...
                        .then(clienteData => {
                            ...
                            $("#tbventa tbody").append(
                                $("<tr>").append(
                                    ...
                                    $("<td>").append(
                                        $("<div>").append(
                                            $("<button>").addClass("btn btn-info btn-sm mr-1").append(
                                                $("<i>").addClass("fas fa-eye").text(" Ver Detalles")
                                            ).data("venta", venta),
                                            $("<button>").attr("type", "button").addClass("btn btn-warning btn-sm").text("Solicitar Factura").data("venta", venta)
                                        )
                                    )
...
=============NUEVO======================
===========================================*/
$("#tbventa tbody").on("click", ".btn-warning", function () {
